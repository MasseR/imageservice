...
, QuickCheck-deriving, recursion-schemes, resourcet, safecopy
, servant, servant-docs, servant-server, split, sqlite-simple
, stdenv, stm, temporary, text, time, transformers, unliftio
, validity, wai, wai-cors, wai-middleware-metrics, warp
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    network-uri optparse-generic QuickCheck QuickCheck-deriving
    recursion-schemes resourcet safecopy servant servant-docs
    servant-server split sqlite-simple stm temporary text time
    transformers unliftio wai wai-cors wai-middleware-metrics warp
    xml-conduit xml-lens
  ];
  ...
  testHaskellDepends = [
    ...
    mtl network-uri optparse-generic QuickCheck QuickCheck-deriving
    recursion-schemes resourcet safecopy servant servant-docs
    servant-server split sqlite-simple stm temporary text time
    transformers unliftio validity wai wai-cors wai-middleware-metrics
    warp xml-conduit xml-lens
  ];
